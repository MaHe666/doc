<template><div><p>在《分布式系统原理与范型》一书中有如下定义：“分布式系统是若干独立计算机的集合，这些计算机对于用户来说就像单个相关系统”；</p>
...
<p>因为，分布式系统要解决的问题本身就是和单机系统一样的，而由于分布式系统多节点、通过网络通信的拓扑结构，会引入很多单机系统没有的问题，为了解决这些问题又会引入更多的机制、协议，带来更多的问题。</p>
<hr>
...
<p>相关文章：</p>
<ul>
<li><a href="https://www.jianshu.com/p/2accc2840a1b" target="_blank" rel="noopener noreferrer">https://www.jianshu.com/p/2accc2840a1b<ExternalLinkIcon/></a></li>
</ul>
<p>RPC的两个核心模块：<code v-pre>通信</code> 和 <code v-pre>序列化</code></p>
</div></template>
