import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as i,c as r,d as e,e as a,a as c,f as t}from"./app-5b6dfdb5.js";const d={},o={href:"https://zhuanlan.zhihu.com/p/372062996",target:"_blank",rel:"noopener noreferrer"},p=t(`<p>将容器卷到物理机，需要新建内容：</p><blockquote><p>data 文件夹</p><p>conf.d 文件夹</p><p>my.cnf 配置文件</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull mysql:5.7
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li></ol>`,8);function m(v,u){const s=l("ExternalLinkIcon");return i(),r("div",null,[e("p",null,[a("相关博客："),e("a",o,[a("https://zhuanlan.zhihu.com/p/372062996"),c(s)])]),p])}const h=n(d,[["render",m],["__file","安装MySQL5.7.html.vue"]]);export{h as default};
