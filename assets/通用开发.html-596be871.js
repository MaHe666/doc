import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o,c,d as n,e as s,a as e,f as t}from"./app-6c4d8416.js";const i={},u=t(`<h2 id="配置端口和项目前缀" tabindex="-1"><a class="header-anchor" href="#配置端口和项目前缀" aria-hidden="true">#</a> 配置端口和项目前缀</h2><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">server</span><span class="token punctuation">:</span>
