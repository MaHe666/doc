<template><div><p>相关博客：<a href="https://zhuanlan.zhihu.com/p/372062996" target="_blank" rel="noopener noreferrer">https://zhuanlan.zhihu.com/p/372062996<ExternalLinkIcon/></a></p>
<p>将容器卷到物理机，需要新建内容：</p>
<blockquote>
<p>data 文件夹</p>
<p>conf.d 文件夹</p>
...
<li>
<p>看到containerId之后，进入容器</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> <span class="token builtin class-name">exec</span> <span class="token parameter variable">-it</span> containerId <span class="token function">bash</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>进入mysql</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>mysql <span class="token parameter variable">-uroot</span> <span class="token parameter variable">-proot</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ol>
</div></template>
