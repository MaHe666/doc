<template><div><p>官网：<a href="https://pandas.pydata.org/" target="_blank" rel="noopener noreferrer">https://pandas.pydata.org/<ExternalLinkIcon/></a></p>
<p>中文官网：<a href="https://www.pypandas.cn/" target="_blank" rel="noopener noreferrer">https://www.pypandas.cn/<ExternalLinkIcon/></a></p>
<p>Pandas是Python编程语言的用于数据操纵和分析的软件库。</p>
<p>特别是，它提供操纵数值表格和时间序列的数据结构和运算操作</p>
<h2 id="简单的输出excel" tabindex="-1"><a class="header-anchor" href="#简单的输出excel" aria-hidden="true">#</a> 简单的输出excel</h2>
...
<h2 id="简单的读取excel" tabindex="-1"><a class="header-anchor" href="#简单的读取excel" aria-hidden="true">#</a> 简单的读取excel</h2>
<h3 id="处理列表头" tabindex="-1"><a class="header-anchor" href="#处理列表头" aria-hidden="true">#</a> 处理列表头</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="读取时指定索引列" tabindex="-1"><a class="header-anchor" href="#读取时指定索引列" aria-hidden="true">#</a> 读取时指定索引列</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
<h2 id="行-列-单元格" tabindex="-1"><a class="header-anchor" href="#行-列-单元格" aria-hidden="true">#</a> 行，列，单元格</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="pandas中dataframe定位数据单元格的方法集锦" tabindex="-1"><a class="header-anchor" href="#pandas中dataframe定位数据单元格的方法集锦" aria-hidden="true">#</a> pandas中DataFrame定位数据单元格的方法集锦</h3>
<p>相关博客：</p>
<ul>
<li>
<p><a href="https://blog.csdn.net/weixin_30650859/article/details/97578737" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/weixin_30650859/article/details/97578737<ExternalLinkIcon/></a></p>
</li>
<li>
<p><a href="https://www.cnblogs.com/guxh/p/8627251.html" target="_blank" rel="noopener noreferrer">https://www.cnblogs.com/guxh/p/8627251.html<ExternalLinkIcon/></a></p>
</li>
</ul>
<hr>
<h2 id="数据填充" tabindex="-1"><a class="header-anchor" href="#数据填充" aria-hidden="true">#</a> 数据填充</h2>
<h3 id="填充数字-字符串及日期" tabindex="-1"><a class="header-anchor" href="#填充数字-字符串及日期" aria-hidden="true">#</a> 填充数字，字符串及日期</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件" tabindex="-1"><a class="header-anchor" href="#附件" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/Books.xlsx')" download>Books.xlsx</a></p>
<h3 id="填充函数-计算列" tabindex="-1"><a class="header-anchor" href="#填充函数-计算列" aria-hidden="true">#</a> 填充函数，计算列</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
<span class="token keyword">print</span><span class="token punctuation">(</span>books<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-1" tabindex="-1"><a class="header-anchor" href="#附件-1" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/Books2.xlsx')" download>Books2.xlsx</a></p>
<hr>
<h2 id="排序-多重排序" tabindex="-1"><a class="header-anchor" href="#排序-多重排序" aria-hidden="true">#</a> 排序，多重排序</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-2" tabindex="-1"><a class="header-anchor" href="#附件-2" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/Items.xlsx')" download>Items.xlsx</a></p>
<hr>
<h2 id="数据筛选-过滤" tabindex="-1"><a class="header-anchor" href="#数据筛选-过滤" aria-hidden="true">#</a> 数据筛选，过滤</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-3" tabindex="-1"><a class="header-anchor" href="#附件-3" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/Score1.xlsx')" download>Score1.xlsx</a></p>
<hr>
<h2 id="柱状图" tabindex="-1"><a class="header-anchor" href="#柱状图" aria-hidden="true">#</a> 柱状图</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-4" tabindex="-1"><a class="header-anchor" href="#附件-4" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/BarChart.xlsx')" download>BarChart.xlsx</a></p>
<h3 id="分组柱状图深度优化" tabindex="-1"><a class="header-anchor" href="#分组柱状图深度优化" aria-hidden="true">#</a> 分组柱状图深度优化</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
<span class="token keyword">import</span> matplotlib<span class="token punctuation">.</span>pyplot <span class="token keyword">as</span> plt
...
plt<span class="token punctuation">.</span>show<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-5" tabindex="-1"><a class="header-anchor" href="#附件-5" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/BarChart2.xlsx')" download>BarChart2.xlsx</a></p>
<h3 id="叠加水平柱状图" tabindex="-1"><a class="header-anchor" href="#叠加水平柱状图" aria-hidden="true">#</a> 叠加水平柱状图</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
<span class="token keyword">import</span> matplotlib<span class="token punctuation">.</span>pyplot <span class="token keyword">as</span> plt
...
plt<span class="token punctuation">.</span>show<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-6" tabindex="-1"><a class="header-anchor" href="#附件-6" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/BarChart3.xlsx')" download>BarChart3.xlsx</a></p>
<hr>
<h2 id="饼状图" tabindex="-1"><a class="header-anchor" href="#饼状图" aria-hidden="true">#</a> 饼状图</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
<span class="token keyword">import</span> matplotlib<span class="token punctuation">.</span>pyplot <span class="token keyword">as</span> plt
...
plt<span class="token punctuation">.</span>show<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-7" tabindex="-1"><a class="header-anchor" href="#附件-7" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/PieChart.xlsx')" download>PieChart.xlsx</a></p>
<hr>
<h2 id="折线图与叠加区域图" tabindex="-1"><a class="header-anchor" href="#折线图与叠加区域图" aria-hidden="true">#</a> 折线图与叠加区域图</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
<span class="token keyword">import</span> matplotlib<span class="token punctuation">.</span>pyplot <span class="token keyword">as</span> plt
...
plt<span class="token punctuation">.</span>show<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-8" tabindex="-1"><a class="header-anchor" href="#附件-8" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/LineChart.xlsx')" download>LineChart.xlsx</a></p>
<hr>
<h2 id="散点图" tabindex="-1"><a class="header-anchor" href="#散点图" aria-hidden="true">#</a> 散点图</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
<span class="token keyword">import</span> matplotlib<span class="token punctuation">.</span>pyplot <span class="token keyword">as</span> plt
...
plt<span class="token punctuation">.</span>show<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-9" tabindex="-1"><a class="header-anchor" href="#附件-9" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/ScatterChart.xlsx')" download>ScatterChart.xlsx</a></p>
<hr>
<h2 id="直方图与密度图" tabindex="-1"><a class="header-anchor" href="#直方图与密度图" aria-hidden="true">#</a> 直方图与密度图</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
<span class="token keyword">import</span> matplotlib<span class="token punctuation">.</span>pyplot <span class="token keyword">as</span> plt
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-10" tabindex="-1"><a class="header-anchor" href="#附件-10" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/Histogram.xlsx')" download>Histogram.xlsx</a></p>
<hr>
<h2 id="多表联合" tabindex="-1"><a class="header-anchor" href="#多表联合" aria-hidden="true">#</a> 多表联合</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-11" tabindex="-1"><a class="header-anchor" href="#附件-11" aria-hidden="true">#</a> 附件</h4>
<ul>
<li>
<p><a :href="$withBase('/files/Python/Pandas/name.xlsx')" download>name.xlsx</a></p>
</li>
<li>
<p><a :href="$withBase('/files/Python/Pandas/score2.xlsx')" download>score2.xlsx</a></p>
</li>
</ul>
<hr>
<h2 id="数据校验-轴的概念" tabindex="-1"><a class="header-anchor" href="#数据校验-轴的概念" aria-hidden="true">#</a> 数据校验，轴的概念</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-12" tabindex="-1"><a class="header-anchor" href="#附件-12" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/DataValidation.xlsx')" download>DataValidation.xlsx</a></p>
<hr>
<h2 id="将一列数据分割成两列" tabindex="-1"><a class="header-anchor" href="#将一列数据分割成两列" aria-hidden="true">#</a> 将一列数据分割成两列</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
<span class="token keyword">print</span><span class="token punctuation">(</span>data<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-13" tabindex="-1"><a class="header-anchor" href="#附件-13" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/SeperateCol.xlsx')" download>SeperateCol.xlsx</a></p>
<hr>
<h2 id="求和、求平均-统计导引" tabindex="-1"><a class="header-anchor" href="#求和、求平均-统计导引" aria-hidden="true">#</a> 求和、求平均，统计导引</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
<span class="token keyword">print</span><span class="token punctuation">(</span>data<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-14" tabindex="-1"><a class="header-anchor" href="#附件-14" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/SeperateCol.xlsx')" download>SeperateCol.xlsx</a></p>
<hr>
<h2 id="定位-消除重复数据" tabindex="-1"><a class="header-anchor" href="#定位-消除重复数据" aria-hidden="true">#</a> 定位，消除重复数据</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-15" tabindex="-1"><a class="header-anchor" href="#附件-15" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/RemoveDuplicatedData.xlsx')" download>RemoveDuplicatedData.xlsx</a></p>
<hr>
<h2 id="旋转表格" tabindex="-1"><a class="header-anchor" href="#旋转表格" aria-hidden="true">#</a> 旋转表格</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
<span class="token keyword">print</span><span class="token punctuation">(</span>df<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-16" tabindex="-1"><a class="header-anchor" href="#附件-16" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/RotateTable.xlsx')" download>RotateTable.xlsx</a></p>
<hr>
<h2 id="读取csv-tsv-txt-html" tabindex="-1"><a class="header-anchor" href="#读取csv-tsv-txt-html" aria-hidden="true">#</a> 读取csv，tsv，txt，html</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-17" tabindex="-1"><a class="header-anchor" href="#附件-17" aria-hidden="true">#</a> 附件</h4>
<ul>
<li>
<p><a :href="$withBase('/files/Python/Pandas/html.htm')" download>html.htm</a></p>
</li>
<li>
<p><a :href="$withBase('/files/Python/Pandas/txt.txt')" download>txt.txt</a></p>
</li>
<li>
<p><a :href="$withBase('/files/Python/Pandas/csv.csv')" download>csv.csv</a></p>
</li>
</ul>
<hr>
<h2 id="透视表、分组、聚合" tabindex="-1"><a class="header-anchor" href="#透视表、分组、聚合" aria-hidden="true">#</a> 透视表、分组、聚合</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-18" tabindex="-1"><a class="header-anchor" href="#附件-18" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/PivotTable.xlsx')" download>PivotTable.xlsx</a></p>
<hr>
<h2 id="线性回归-预测趋势" tabindex="-1"><a class="header-anchor" href="#线性回归-预测趋势" aria-hidden="true">#</a> 线性回归，预测趋势</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
<span class="token keyword">import</span> matplotlib<span class="token punctuation">.</span>pyplot <span class="token keyword">as</span> plt
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-19" tabindex="-1"><a class="header-anchor" href="#附件-19" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/LinearRegression.xlsx')" download>LinearRegression.xlsx</a></p>
<hr>
<h2 id="条件格式" tabindex="-1"><a class="header-anchor" href="#条件格式" aria-hidden="true">#</a> 条件格式</h2>
<p>这里我们需要用到 Jupyter notebook</p>
<p>打开Anaconda Prompt，输入jupyter notebook或者直接打开jupyter notebook</p>
<p>然后点击左上角的new，选择Python3</p>
<h4 id="附件-20" tabindex="-1"><a class="header-anchor" href="#附件-20" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/ConditionalFormat.xlsx')" download>ConditionalFormat.xlsx</a></p>
<h3 id="按照条件修改数据颜色" tabindex="-1"><a class="header-anchor" href="#按照条件修改数据颜色" aria-hidden="true">#</a> 按照条件修改数据颜色</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
<span class="token comment">#apply是按照行或列进行施加，applymap是无差别施加</span>
data<span class="token punctuation">.</span>style<span class="token punctuation">.</span>applymap<span class="token punctuation">(</span>low_num_red<span class="token punctuation">,</span>subset<span class="token operator">=</span><span class="token punctuation">[</span><span class="token string">'num1'</span><span class="token punctuation">,</span><span class="token string">'num2'</span><span class="token punctuation">,</span><span class="token string">'num3'</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token builtin">apply</span><span class="token punctuation">(</span>high_num_green<span class="token punctuation">,</span>subset<span class="token operator">=</span><span class="token punctuation">[</span><span class="token string">'num1'</span><span class="token punctuation">,</span><span class="token string">'num2'</span><span class="token punctuation">,</span><span class="token string">'num3'</span><span class="token punctuation">]</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="按照条件修改数据颜色填充度" tabindex="-1"><a class="header-anchor" href="#按照条件修改数据颜色填充度" aria-hidden="true">#</a> 按照条件修改数据颜色填充度</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
<h2 id="行操作集锦" tabindex="-1"><a class="header-anchor" href="#行操作集锦" aria-hidden="true">#</a> 行操作集锦</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
...
<span class="token keyword">print</span><span class="token punctuation">(</span>data<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-21" tabindex="-1"><a class="header-anchor" href="#附件-21" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/RowOperate.xlsx')" download>RowOperate.xlsx</a></p>
<hr>
<h2 id="列操作集锦" tabindex="-1"><a class="header-anchor" href="#列操作集锦" aria-hidden="true">#</a> 列操作集锦</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> pandas <span class="token keyword">as</span> pd
<span class="token keyword">import</span> numpy <span class="token keyword">as</span> np
...
<span class="token keyword">print</span><span class="token punctuation">(</span>data<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="附件-22" tabindex="-1"><a class="header-anchor" href="#附件-22" aria-hidden="true">#</a> 附件</h4>
<p><a :href="$withBase('/files/Python/Pandas/ColOperate.xlsx')" download>ColOperate.xlsx</a></p>
<hr>
<h2 id="实战" tabindex="-1"><a class="header-anchor" href="#实战" aria-hidden="true">#</a> 实战</h2>
<h3 id="获取文件夹下的所有文件绝对路径" tabindex="-1"><a class="header-anchor" href="#获取文件夹下的所有文件绝对路径" aria-hidden="true">#</a> 获取文件夹下的所有文件绝对路径</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="设置数据表显示在控制台的属性" tabindex="-1"><a class="header-anchor" href="#设置数据表显示在控制台的属性" aria-hidden="true">#</a> 设置数据表显示在控制台的属性</h3>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment">#设置最大展示的列数</span>
pd<span class="token punctuation">.</span>options<span class="token punctuation">.</span>display<span class="token punctuation">.</span>max_columns <span class="token operator">=</span> <span class="token number">999</span>
