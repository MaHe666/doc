import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,f as t}from"./app-BawJUnT_.js";const p={},e=t(`<h2 id="文件的下载" tabindex="-1"><a class="header-anchor" href="#文件的下载"><span>文件的下载</span></a></h2><p>文件的下载去看Servlet的响应部分，那里有写</p><h2 id="文件上传的注意事项" tabindex="-1"><a class="header-anchor" href="#文件上传的注意事项"><span>文件上传的注意事项</span></a></h2><p>面试时人家问你怎么调优，就是这四句话</p><ol><li>为保证服务器安全，上传文件应该放在外界无法直接访问的目录下，比如放于WEB-INF目录下。</li><li>为防止文件覆盖的现象发生，要为上传文件产生一个唯一的文件名</li><li>要限制上传文件的最大值。</li><li>可以限制上传文件的类型，在收到上传文件名时，判断后缀名是否合法。</li></ol><h2 id="maven依赖" tabindex="-1"><a class="header-anchor" href="#maven依赖"><span>Maven依赖</span></a></h2><div class="language-xml line-numbers-mode" data-ext="xml" data-title="xml"><pre class="language-xml"><code><span class="token comment">&lt;!-- https://mvnrepository.com/artifact/commons-fileupload/commons-fileupload --&gt;</span>
